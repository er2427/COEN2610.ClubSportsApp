...
public class SignUpPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(accountMade){ //if an account is made, bring them to the login page
                    Intent loginIntent = new Intent(SignUpPage.this, com.marquette.clubsportsappnew.ui.account_info.LoginPage.class);
        ...
        backToLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v){
                Intent intent3 = new Intent(SignUpPage.this, com.marquette.clubsportsappnew.ui.account_info.LoginPage.class);
