...
import com.marquette.clubsportsappnew.databinding.LoginPageBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void navigateToMainPage(String username) {
        Intent intent = new Intent(getApplicationContext(), com.marquette.clubsportsappnew.MainActivity.class);
